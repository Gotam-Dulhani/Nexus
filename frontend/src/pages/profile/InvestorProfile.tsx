        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <Card>
            ...
            <CardBody>
              <div className="space-y-4">
                ...
                <div>
                  <h3 className="text-md font-medium text-gray-900 dark:text-white">Investment Criteria</h3>
          ...
          <Card>
            <CardHeader className="flex justify-between items-center">
              ...
              <span className="text-sm text-gray-500 dark:text-gray-400">{investor.portfolioCompanies.length} companies</span>
            </CardHeader>
            <CardBody>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {investor.portfolioCompanies.length > 0 ? investor.portfolioCompanies.map((company: string, index: number) => (
                  <div key={index} className="flex items-center p-3 border border-gray-200 dark:border-gray-800 rounded-md">
                    <div className="p-3 bg-primary-50 dark:bg-primary-900/10 rounded-md mr-3">
                      <Briefcase size={18} className="text-primary-700 dark:text-primary-400" />
                    </div>
                    <div>
                  ...
                  <p className="text-gray-500 dark:text-gray-400 text-sm col-span-2">No portfolio companies listed yet.</p>
                )}
              </div>
            </CardBody>
          </Card>
          ...
          <Card>
            ...
            <CardBody>
              <div className="space-y-4">
                ...
                <div>
                  <span className="text-sm text-gray-500 dark:text-gray-400">Typical Investment Timeline</span>
                  <p className="text-md font-medium text-gray-900 dark:text-white">3-5 years</p>
                </div>
                
                <div className="pt-3 border-t border-gray-100 dark:border-gray-800">
                  <span className="text-sm text-gray-500 dark:text-gray-400">Investment Focus</span>
                  <div className="mt-2 space-y-2">
                    <div className="flex justify-between items-center">
                      <span className="text-xs font-medium dark:text-gray-300">SaaS & B2B</span>
                      <div className="w-32 bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                        <div className="bg-primary-600 h-2 rounded-full" style={{ width: '75%' }}></div>
                      </div>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-xs font-medium dark:text-gray-300">FinTech</span>
                      <div className="w-32 bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                        <div className="bg-primary-600 h-2 rounded-full" style={{ width: '60%' }}></div>
                      </div>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-xs font-medium dark:text-gray-300">HealthTech</span>
                      <div className="w-32 bg-gray-200 dark:bg-gray-700 rounded-full h-2">
          ...
          <Card>
            ...
            <CardBody>
              <div className="space-y-3">
                <div className="p-3 border border-gray-200 dark:border-gray-800 rounded-md bg-gray-50 dark:bg-gray-800/50">
                  <div className="flex justify-between items-center">
                    <div>
                      <h3 className="text-sm font-medium text-gray-900 dark:text-white">Successful Exits</h3>
                      <p className="text-xl font-semibold text-primary-700 dark:text-primary-400 mt-1">4</p>
                    </div>
                ...
                <div className="p-3 border border-gray-200 dark:border-gray-800 rounded-md bg-gray-50 dark:bg-gray-800/50">
                  <div className="flex justify-between items-center">
                    <div>
                      ...
                      <p className="text-xl font-semibold text-primary-700 dark:text-primary-400 mt-1">3.2x</p>
                    </div>
                    <BarChart3 size={24} className="text-primary-600 dark:text-primary-400" />
                  </div>
                </div>
                ...
                <div className="p-3 border border-gray-200 dark:border-gray-800 rounded-md bg-gray-50 dark:bg-gray-800/50">
                  <div className="flex justify-between items-center">
                    <div>
                      <h3 className="text-sm font-medium text-gray-900 dark:text-white">Active Investments</h3>
                      <p className="text-xl font-semibold text-primary-700 dark:text-primary-400 mt-1">{investor.portfolioCompanies.length}</p>
                    </div>
                    <BarChart3 size={24} className="text-primary-600 dark:text-primary-400" />
                  </div>
                </div>
